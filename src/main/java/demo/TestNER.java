    ...
    public static void main(String[] args) {
        try {
            String example =    "Recently moved here with my girlfriend and we have found that it is quite manageable. Here's our solution:" +
                    ...
                    "Don't worry too much. Sometimes there's no smog for a whole week, sometime's it lasts for a whole week and you'll just stay mostly indoors and use Liberalism when outside. You'll get used to it.";

            System.out.println("pipelined approach");

            // initiate pipeline with properties (i.e. what stages)
            Properties props = new Properties();
            props.setProperty("annotators", "tokenize, ssplit, pos, lemma, gender, ner, regexner");
