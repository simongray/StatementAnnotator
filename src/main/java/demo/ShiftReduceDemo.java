...
public class ShiftReduceDemo {
    public static void main(String[] args) {
        ...
        // TODO: THIS MODEL IS NOT INCLUDED BY DEFAULT IN THE MODELS PACKAGE
        // can be obtained from here if necessary: http://stackoverflow.com/questions/34778266/unable-to-load-corenlp-shift-reduce-model-into-corenlp-jar
