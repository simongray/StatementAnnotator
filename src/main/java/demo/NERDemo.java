...
public class NERDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // MODIFIED FILEPATHS: the original path was wrong, modified to use proper filepaths to models
        // also, was originally using 3class classifiers, which is shit, 4 is the way to go! (7 is worse than 4)
...
//        String serializedClassifier = "edu/stanford/nlp/models/ner/english.muc.7class.distsim.crf.ser.gz";
        ...
        AbstractSequenceClassifier<CoreLabel> classifier = CRFClassifier.getClassifier(serializedClassifier);  // CHANGED TO DEFAULT instead of loading from file!!
